...
- MongoLab was dead, so Mongo Atlas

<br/>

- Build for Production

  - translate our server to work with old code

  - make folder to execute with old code

  - steps

    1. npm run build:server

       - babel is not building **static files** and **views**

    2. npm run build:assets

    3. npm run build

       - delete original build/ and re-build
    ...
    4. npm start
       ...
       - ```
         Error: Failed to lookup view "home" in views directory "D:\Programming\nomad_coders\youtube_clone\views"
         ```
